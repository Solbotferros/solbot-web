export const serviceAreasTranslations = {
  es: {
    serviceAreas: {
      title: 'Áreas de servicio en Barcelona y alrededores',
      subtitle:
  ...
  ca: {
    serviceAreas: {
      title: 'Àrees de servei a Barcelona i rodalies',
      subtitle:
  ...
  en: {
    serviceAreas: {
      title: 'Service Areas in Barcelona and Surrounding Regions',
      subtitle:
